...
`1 000 000 000 bytes ÷ 24 bytes per rank × 1 second per move ÷ 2 ranks per move ÷ 31 557 600 seconds per year ≈ 0.6 years`
(White moves a knight down Black's side and vice versa)
